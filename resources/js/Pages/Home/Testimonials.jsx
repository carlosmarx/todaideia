      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Veja alguns depoimentos de clientes nossos</h2>
            <p className="text-xl text-gray-400">Temos mais de 15 anos de experiência no mercado de tecnologia.</p>
          </div>
