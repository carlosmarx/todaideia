      ...
      <div className="py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm">
                ...
                <ul>
                  <li className="mb-1">
                    <a href="#" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Web sites</a>
                  </li>
                  <li className="mb-1">
                    <a href="#" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Aplicativos mobile</a>
                  </li>
                  <li className="mb-1">
                    <a href="#" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Automação</a>
                  </li>
                  <li className="mb-1">
                    <a href="#" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Sistemas corporativos</a>
                  </li>
                </ul>
              </div>
              ...
              {/* 4th block */}
              <div className="text-sm">
                <h6 className="text-gray-200 font-medium mb-1">Sobre nós</h6>
                <ul>
                  <li className="mb-1">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; RL Tecnologia. Todos os direitos reservados.</div>
