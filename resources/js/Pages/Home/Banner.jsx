        ...
        <div className="fixed bottom-0 right-0 w-full md:bottom-8 md:right-12 md:w-auto z-60">
          <div className="bg-slate-800 text-slate-50 text-sm p-3 md:rounded shadow-lg flex justify-between">
            <div className="text-slate-500 inline-flex">
              <a className="font-medium hover:underline text-emerald-400 flex items-center gap-2" href="https://wa.me/5586994601399" target="_blank" rel="noreferrer">
                Nosso whatsapp <MdWhatsapp size={22} />
              </a>
            </div>
