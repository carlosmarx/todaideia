function Header() {
  ...
  return (
    <>
        ...
        <div className="container mb-1 lg:mt-1 mx-auto">
            <section className="">
                <div
                className="alert alert-dismissible fade show items-center justify-between lg:rounded-lg bg-red-500 py-4 px-6 text-center text-white md:flex md:text-left">
