    ...
    <div className="flex flex-col min-h-screen overflow-hidden">
      ...
      <main className="flex items-center justify-center h-screen">
        <div className="flex flex-col items-center justify-center">
                <img src="./images/Logo_Todaideia.png" alt="Logo Todaideia" className="w-64" />
                <h1 className="my-2 text-[#E61484] text-3xl">Em breve!</h1>
                <div>
                    <img src="/images/whatsapp.png" alt="Fale consoco no whatsapp" className="w-64 border-8 rounded-lg border-green-300" />
                </div>
                <div className="flex m-3 text-[#FFF] lg:text-4xl text-2xl bg-green-500 py-4 px-6 rounded-md hover:bg-green-400 gap-2 justify-center items-center">
                    ...
                    <h1 className="">
                        <a href="https://wa.me/5586994144081">
                            Fale conosco
                        </a>
                    </h1>
                </div>
